...
# --- RIFE (flownet.pkl) ---
RIFE_DIR="$COMFYUI_DIR/models/sonic"
mkdir -p "$RIFE_DIR"
echo "Baixando flownet.pkl para ComfyUI/models/sonic/RIFE..."
...
VIDEO_HELPER_SUITE_DIR="$COMFYUI_DIR/VideoHelperSuite" # É um Custom Node
